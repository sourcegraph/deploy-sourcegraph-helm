...
1. Component default (e.g., .Values.migrator.defaultContainerSecurityContext)
2. Global override (e.g., .Values.sourcegraph.containerSecurityContext)
3. Component override (e.g., .Values.migrator.containerSecurityContext)
...
Usage:
  {{- include "sourcegraph.containerSecurityContext" (list . "migrator" 8) }}
...
Usage:
  {{- include "sourcegraph.podSecurityContext" (list . "migrator" 6) }}
