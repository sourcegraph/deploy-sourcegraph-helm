...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 3.43.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 3.43.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"3.43.0@sha256:d61df586e051294252b9a67ed98843ea1428a351952f84eab93585fdae296227"` | Docker image tag for the `migrator` image |
