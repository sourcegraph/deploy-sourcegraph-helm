...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.4.3643 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.4.3643 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.4.3643@sha256:a4f3d55549a6f6601f57fd5f5851ec8a2772d71fe305b0c3d2dbb389bb358581"` | Docker image tag for the `migrator` image |
