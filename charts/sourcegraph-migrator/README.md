...
| migrator.image.defaultTag | string | `"5.4.3643@sha256:65b1380c726f1216a2dff87988081878bacb70b9d60727a0cdffa60ea7f28d8c"` | Docker image tag for the `migrator` image |
