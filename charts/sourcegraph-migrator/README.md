...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.10.3349 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.10.3349 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.10.3349@sha256:fef3e3bc485f94dc173a658de31dbc0f71e256a39106e2e8ec64ec71186b47a4"` | Docker image tag for the `migrator` image |
