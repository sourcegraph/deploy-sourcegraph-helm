...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.1.1 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.1.1 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.1.1@sha256:8f07f625135493c0d7078f24a41ff304169bf7583ddb18175e27ea857850eb42"` | Docker image tag for the `migrator` image |
