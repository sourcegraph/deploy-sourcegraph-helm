...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 7.0.2178 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 7.0.2178 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"7.0.2178@sha256:7452b42e58c1bedf42bcb1de59d57513825ad0143d6829ce9a77c671224a1540"` | Docker image tag for the `migrator` image |
