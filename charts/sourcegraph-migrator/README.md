...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.0.12741 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.0.12741 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.0.12741@sha256:dde18fed445c5b642d655450c4f34a7cefc6454ac72d236010cad667b1647c09"` | Docker image tag for the `migrator` image |
