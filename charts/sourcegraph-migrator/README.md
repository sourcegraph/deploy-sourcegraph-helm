...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.1.5633 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.1.5633 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.1.5633@sha256:d9b01813927432810e3fb86f2f29f073384fde636bc2f7e6654f59c026571524"` | Docker image tag for the `migrator` image |
