...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.11.3601 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.11.3601 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.11.3601@sha256:1c95b64baea122eecdac8b1e78d147b64a619b2446d75a51e26f23e705e88aea"` | Docker image tag for the `migrator` image |
