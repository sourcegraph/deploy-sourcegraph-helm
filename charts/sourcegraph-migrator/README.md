...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 3.42.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 3.42.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"3.42.0@sha256:a4c2000ad634d1e4abb8a983c9cdff49cc45a0b33dea5ce3da1455300440dc17"` | Docker image tag for the `migrator` image |
