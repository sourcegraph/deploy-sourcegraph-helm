...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.4.3500 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.4.3500 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.4.3500@sha256:c7e022bf07dc4a13db9ff1c21d442f9705ade76dcc6ec8c12a0ee299c342861d"` | Docker image tag for the `migrator` image |
