...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.11.4013 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.11.4013 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.11.4013@sha256:f313ed43e610189646025c0a3f3fc9949a5bad527d61925d7b591c54cb9dc6f2"` | Docker image tag for the `migrator` image |
