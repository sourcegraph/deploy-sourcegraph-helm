...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.10.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.10.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.10.0@sha256:0abe2500352cf8129e3944bbb2a93b5ba571557a1711f127775a3774bc860c84"` | Docker image tag for the `migrator` image |
