...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.10.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.10.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.10.0@sha256:780a1256268107f57cd69c09c0699f636dd20b17ee5d9d04d34f2f9e6512079c"` | Docker image tag for the `migrator` image |
