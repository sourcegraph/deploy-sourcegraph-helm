...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.9.902 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.9.902 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.9.902@sha256:028cd854071de5a2b42c2884c0c32a842bcaa4a3ace5c8554c7af8de33c48658"` | Docker image tag for the `migrator` image |
