...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.12.1287 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.12.1287 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.12.1287@sha256:7662045a0f520aea7809c1ee514f15173ddaa1d44e0b5037eda9e308d3af1ee7"` | Docker image tag for the `migrator` image |
