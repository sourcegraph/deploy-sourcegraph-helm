...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.5.1337 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.5.1337 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.5.1337@sha256:9f764de646e91114d7eaf981119dd78a0b6bcf77ad96540364f3104606909f0d"` | Docker image tag for the `migrator` image |
