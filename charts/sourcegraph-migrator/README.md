...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.7.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.7.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.7.0@sha256:a8d6ff4d8843b5aa371fb1ce2ca8f8c3878423382542e9fa9f7307f70b5c045d"` | Docker image tag for the `migrator` image |
