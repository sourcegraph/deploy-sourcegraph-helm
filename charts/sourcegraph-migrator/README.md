...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.4.7765 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.4.7765 sg-migrator sourcegraph/sourcegraph-migrator
```
