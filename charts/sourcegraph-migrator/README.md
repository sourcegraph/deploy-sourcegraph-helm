...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.9.45 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.9.45 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.9.45@sha256:9a71811cbca5fcf209ca0815e48444b250ff530bd994bf9d0c042f909831e76d"` | Docker image tag for the `migrator` image |
