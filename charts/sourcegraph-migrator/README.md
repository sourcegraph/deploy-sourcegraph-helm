...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.5.2463 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.5.2463 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.5.2463@sha256:6e73b62d00646955c108e62aa4a81be5fa8a4370553702b21d8a43d82c00277a"` | Docker image tag for the `migrator` image |
