...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 7.3.2527 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 7.3.2527 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"7.3.2527@sha256:f0553e6ff589ca388a6a5f0e5aaa458419802ac67a59adc4d99a111af981e861"` | Docker image tag for the `migrator` image |
