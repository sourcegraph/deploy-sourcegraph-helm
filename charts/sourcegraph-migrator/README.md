...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.5.2654 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.5.2654 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.5.2654@sha256:23825d94caa6ae4ebea9a95d3d919e88100945986e2f95f7add2731913af3e95"` | Docker image tag for the `migrator` image |
