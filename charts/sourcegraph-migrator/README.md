...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.9.17785 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.9.17785 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.9.17785@sha256:55c3826f0dbad71adb66f0083da76040db79f5050ba5be0af35788360881a13d"` | Docker image tag for the `migrator` image |
