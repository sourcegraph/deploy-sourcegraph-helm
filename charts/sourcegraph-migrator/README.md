...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.3.11625 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.3.11625 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.3.11625@sha256:b3a5337d4c45c540a17cfc8082fccd6053ac45aaef79943217cad2405ac01db4"` | Docker image tag for the `migrator` image |
