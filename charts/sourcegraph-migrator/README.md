...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.3.9104 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.3.9104 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.3.9104@sha256:fc709c2f77a118235cec3428bd5a26eed15540e9f05c0d060154280fa0e6a8ea"` | Docker image tag for the `migrator` image |
