...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.9.1277 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.9.1277 sg-migrator sourcegraph/sourcegraph-migrator
```
