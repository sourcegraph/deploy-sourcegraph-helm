...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.5.3738 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.5.3738 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.5.3738@sha256:d5b4729c7f8eb3921b1fe09b78c9a3c2644f9b6b4e658e33356d867fd0eb704a"` | Docker image tag for the `migrator` image |
