...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.0.5 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.0.5 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.0.5@sha256:b09f41c0235057ffbceac07ce874d001d7070e70697544051760c702599b3200"` | Docker image tag for the `migrator` image |
