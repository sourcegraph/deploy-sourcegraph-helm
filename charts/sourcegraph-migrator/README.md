...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.1.7 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.1.7 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.1.7@sha256:aa5b96b2ac6fa1f72a3f4ad5f34f8b6762f63e28aa6f37026cd337a221971da9"` | Docker image tag for the `migrator` image |
