...
| migrator.image.defaultTag | string | `"6.0.12741@sha256:7649ade672e93ebfe2c42356577cd0ed0b9c820db6b01d2db1a7e5db4de79f80"` | Docker image tag for the `migrator` image |
