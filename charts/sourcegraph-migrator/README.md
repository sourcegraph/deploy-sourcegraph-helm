...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.6.2535 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.6.2535 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.6.2535@sha256:d99ad2ebcc52a87cbab0414e8d23812c647ee512c96828d4b01ab5db74324bda"` | Docker image tag for the `migrator` image |
