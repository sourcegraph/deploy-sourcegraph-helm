...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 7.4.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 7.4.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"7.4.0@sha256:c691cad3b7fa783db2327457309acc40c4e111dee3a14bba9fecce775780c6fd"` | Docker image tag for the `migrator` image |
