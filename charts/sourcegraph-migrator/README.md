...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.5.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.5.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.5.0@sha256:a674db63866ead81a0ac1f180281054c5bc255db95832c3151eea5d3cd011546"` | Docker image tag for the `migrator` image |
