...
| migrator.image.defaultTag | string | `"5.5.2463@sha256:1f5d0086f2829112db2a649736ba1a27c5572fa7e8f1c1383e99799f4c80722e"` | Docker image tag for the `migrator` image |
