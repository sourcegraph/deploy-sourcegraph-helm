...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.12.1271 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.12.1271 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.12.1271@sha256:0c1431df5ba243fc9c89ede5594223153ac2df2dd3b763a3d536930249671820"` | Docker image tag for the `migrator` image |
