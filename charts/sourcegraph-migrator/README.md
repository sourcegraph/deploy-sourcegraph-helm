...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.8.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.8.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.8.0@sha256:9804b2acf59e91a610b36cf09fe81cd5eac383cc60b9f1fb33286479cdf11325"` | Docker image tag for the `migrator` image |
