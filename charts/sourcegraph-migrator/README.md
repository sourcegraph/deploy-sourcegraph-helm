...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.3.3 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.3.3 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.3.3@sha256:13f062895d5a5a7fdafb656140d8b732c1451fc71bd1808c1653df8bb9ca1e61"` | Docker image tag for the `migrator` image |
