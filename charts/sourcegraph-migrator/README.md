...
| migrator.image.defaultTag | string | `"6.2.0@sha256:022a6d8be805fe642461901236d894517b8e7f6ed5e46107c6bda1d915f0ef0b"` | Docker image tag for the `migrator` image |
