...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.1.4020 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.1.4020 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.1.4020@sha256:7a8293a916bf2861f121089dbce6efbba891c9e1776bb91306813b9550e2f929"` | Docker image tag for the `migrator` image |
