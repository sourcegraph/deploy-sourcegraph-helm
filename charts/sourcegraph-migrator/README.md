...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.4.5071 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.4.5071 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.4.5071@sha256:d560e457ae3536006bc8c01e3717f130eb2786aeaaf95d52bb5a2b3d8d4e9cf3"` | Docker image tag for the `migrator` image |
