...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.0.1 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.0.1 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.0.1@sha256:9430432c198a9b6d5b094400120b66afbaf634332267ea86c42bc303cf69b0e7"` | Docker image tag for the `migrator` image |
