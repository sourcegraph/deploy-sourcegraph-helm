...
| migrator.image.defaultTag | string | `"5.3.666@sha256:0d908daa0ed40fcc00cd5b64266980c63470b76602f88df10224fa2ffb31398d"` | Docker image tag for the `migrator` image |
