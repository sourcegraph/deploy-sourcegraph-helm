...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.6.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.6.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.6.0@sha256:adb4dbe9214eb6b4abd146da2771ff04c99135a3ce07afa3522091862390e62b"` | Docker image tag for the `migrator` image |
