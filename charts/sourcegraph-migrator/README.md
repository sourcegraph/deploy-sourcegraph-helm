...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.8.2313 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.8.2313 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.8.2313@sha256:9cbb7f8c9c9af8ed7656bf97ae1a92eb0ddfcc15706fc44f050c280787d74715"` | Docker image tag for the `migrator` image |
