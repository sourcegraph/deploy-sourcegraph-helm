...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.8.1579 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.8.1579 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.8.1579@sha256:55b8c4da0ea5400cece44bb933294c0a579bc993c3504a85648c7e7facfac4a6"` | Docker image tag for the `migrator` image |
