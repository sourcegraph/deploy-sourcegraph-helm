...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.3.666 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.3.666 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.3.666@sha256:7cd938208e4f834ba2e8b710902b2c98fc5534b921c749e19a19433ceb81ad36"` | Docker image tag for the `migrator` image |
