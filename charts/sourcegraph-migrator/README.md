...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 3.40.2 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 3.40.2 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"3.40.2@sha256:996616fe88901a1667e386493fe4c5482c9ac4027b8562b16114bebcf7017abd"` | Docker image tag for the `migrator` image |
