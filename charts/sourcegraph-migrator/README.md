...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.4.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.4.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.4.0@sha256:774dd97e08fdd5f7c9efcd206a6c81bfec1efdff921f3e952498b448248af5ef"` | Docker image tag for the `migrator` image |
