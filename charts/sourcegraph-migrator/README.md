...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.2.2553 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.2.2553 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.2.2553@sha256:008bb50022803f84273ab96773297325242c151c9f5b44358f83074524277d33"` | Docker image tag for the `migrator` image |
