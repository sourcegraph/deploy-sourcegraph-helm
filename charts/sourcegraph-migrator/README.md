...
| migrator.image.defaultTag | string | `"5.10.3940@sha256:245c8eac0316a50c169239054aeb1695874b225f84010963bd115aba9fdd787f"` | Docker image tag for the `migrator` image |
