...
| migrator.image.defaultTag | string | `"5.8.1579@sha256:2537c599ad4530aada6d3e47a401eea0e9e59a372ed2db1ef2ed872fd2f93485"` | Docker image tag for the `migrator` image |
