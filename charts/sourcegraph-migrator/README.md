...
| migrator.image.defaultTag | string | `"5.5.3738@sha256:b5d3fbc3af0fe556630b7405579ccf794316128be9806a25c803e77af193feb0"` | Docker image tag for the `migrator` image |
