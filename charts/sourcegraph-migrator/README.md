...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.0.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.0.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.0.0@sha256:c63455c3a9dc7c02c558e425f9a6fadc96a56344944fba03e6bb12fe43b72dbe"` | Docker image tag for the `migrator` image |
