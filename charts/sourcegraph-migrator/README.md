...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.1.2889 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.1.2889 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.1.2889@sha256:f7dc3b1006fa8a031d3c4ee224d21576f930e2522f57bf5bb15094da62211361"` | Docker image tag for the `migrator` image |
