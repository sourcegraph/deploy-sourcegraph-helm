...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.7.229 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.7.229 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.7.229@sha256:7c01607b3559b14a53ad3573b27b8e9f5646612d6046cb339bba4fea6d5c372a"` | Docker image tag for the `migrator` image |
