...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.3.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.3.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.3.0@sha256:37758eec0025661094c4409ccdd1d1dd8c0c2ad0fdc22e8469d715ad92aacb79"` | Docker image tag for the `migrator` image |
