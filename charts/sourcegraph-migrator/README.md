...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.4.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.4.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.4.0@sha256:23f4aa9f733208151abac0b28dcc29ca9df5b01d1d669da76b8be13b07b23397"` | Docker image tag for the `migrator` image |
