...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.7.2518 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.7.2518 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.7.2518@sha256:84503bf2e826fc1f68cd7dcef16eb043bf4f2fedce57c4b101159a5d08e9e882"` | Docker image tag for the `migrator` image |
