...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.3.2692 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.3.2692 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.3.2692@sha256:489c4296ecdda35ec531fd33765be6eb91d54d27259dba2dee25263150277d91"` | Docker image tag for the `migrator` image |
