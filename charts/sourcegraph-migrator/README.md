...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 3.43.2 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 3.43.2 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"3.43.2@sha256:e265a894b95ac083d766a77ed139dcaaa1b242d639e7d8e874bf658748df565e"` | Docker image tag for the `migrator` image |
