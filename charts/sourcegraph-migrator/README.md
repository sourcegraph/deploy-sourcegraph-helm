...
| migrator.image.defaultTag | string | `"5.4.3500@sha256:173aaf2d9dd79a4b43144636357e16ba269c1cc87df11bbbda454791185f13af"` | Docker image tag for the `migrator` image |
