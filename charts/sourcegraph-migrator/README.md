...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.9.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.9.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.9.0@sha256:f610a6c8c6bff80f2d9e950ed3621a09e0edae938020e88b2d9ca896359601ed"` | Docker image tag for the `migrator` image |
