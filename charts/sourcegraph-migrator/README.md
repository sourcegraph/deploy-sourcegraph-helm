...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.1.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.1.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.1.0@sha256:226836da666bdfbb89cef72d65b6239074ec8b04b6cca8788b1d300cd8a65c39"` | Docker image tag for the `migrator` image |
