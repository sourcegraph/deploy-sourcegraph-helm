...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 7.2.1943 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 7.2.1943 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"7.2.1943@sha256:39cb447a746ac9c487575893b9729f1b9d5882c835aca617a5a1160ef5506251"` | Docker image tag for the `migrator` image |
