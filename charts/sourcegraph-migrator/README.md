...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.9.2509 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.9.2509 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.9.2509@sha256:c721fa950a057e94531c30cd302ebe11771588bd736e6a35fa59743a94dcaa99"` | Docker image tag for the `migrator` image |
