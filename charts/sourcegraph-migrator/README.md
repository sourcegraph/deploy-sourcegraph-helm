...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.4.3889 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.4.3889 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.4.3889@sha256:7c0ce38b43b1b0acb6e5df07ec413dbc1e69e7e88e6bfb9a984ef29fc0dcc574"` | Docker image tag for the `migrator` image |
