...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.11.5639 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.11.5639 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.11.5639@sha256:76a95f51c19042e478064a37c3f716370ae085ece85edee28e96b33d7ae3276f"` | Docker image tag for the `migrator` image |
