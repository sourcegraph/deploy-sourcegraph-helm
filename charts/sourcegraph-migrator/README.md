...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.5.160 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.5.160 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.5.160@sha256:9878f33a2e31ce3c16eca7fe6882088b65a9588167499b44dc78d38ab2b3be29"` | Docker image tag for the `migrator` image |
