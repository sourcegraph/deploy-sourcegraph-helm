...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.2.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.2.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.2.0@sha256:dc78256f56ac63851fc94a553622f514b6c04bd9300cd08b4548615ffde1aa46"` | Docker image tag for the `migrator` image |
