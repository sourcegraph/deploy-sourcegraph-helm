...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.4.2198 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.4.2198 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.4.2198@sha256:9c3f106a3847c00b13b62cc6cddc966e8d0175d2fd516b7731fff1186370afe8"` | Docker image tag for the `migrator` image |
