...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.11.5428 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.11.5428 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.11.5428@sha256:caaea98f8dfc69c409ed7b9c803a773fd31884dcfe75874525da9e3b33b2ae18"` | Docker image tag for the `migrator` image |
