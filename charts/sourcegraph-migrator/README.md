...
| migrator.image.defaultTag | string | `"5.5.3956@sha256:0aaded890387301c2cc642b85f78eddcd2e9674a72c6a2354f59dbc925ff999d"` | Docker image tag for the `migrator` image |
