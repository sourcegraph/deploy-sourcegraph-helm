...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.12.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.12.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.12.0@sha256:b12184766122a8f22cef78f8ecbfd5cd20837f9d480716cea0e031e9f505b1f1"` | Docker image tag for the `migrator` image |
