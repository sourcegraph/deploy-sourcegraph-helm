...
| migrator.image.defaultTag | string | `"5.8.0@sha256:7a93083744fe9a8ab4b83dd7a6c8a2b815339bae1aff0417c757d799139b463c"` | Docker image tag for the `migrator` image |
