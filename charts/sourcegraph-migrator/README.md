...
| migrator.image.defaultTag | string | `"5.1.2@sha256:b9789a7bb219ffcebf37f9e48ca3a8909bde031e064b4663353f73f0a661cd79"` | Docker image tag for the `migrator` image |
