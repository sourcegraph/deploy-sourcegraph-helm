...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 6.3.4167 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 6.3.4167 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"6.3.4167@sha256:b85ffffd61f65daba4d5be075d97f6b5f2a9a0d74922a18dce144d1e0e02ef25"` | Docker image tag for the `migrator` image |
