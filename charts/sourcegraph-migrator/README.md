...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 5.4.5099 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 5.4.5099 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"5.4.5099@sha256:f52f84eb041f64a423c1da5071e42b186437daecbcc67f5e7207eb83625ff58c"` | Docker image tag for the `migrator` image |
