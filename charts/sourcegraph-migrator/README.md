...
```sh
helm upgrade --install -f <your-override-file.yaml> --version 7.0.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
```sh
helm upgrade --install -f <your-override-file.yaml> --set "migrator.args={add-log,-db=frontend,-version=1528395834}" --version 7.0.0 sg-migrator sourcegraph/sourcegraph-migrator
```
...
| migrator.image.defaultTag | string | `"7.0.0@sha256:7172e3262f3bc48d82285955764d2ff8191683dfb32edfbc12dede62adc73059"` | Docker image tag for the `migrator` image |
