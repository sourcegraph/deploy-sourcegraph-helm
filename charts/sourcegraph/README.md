...
| alpine.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `alpine` image |
...
| blobstore.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `blobstore` image |
...
| cadvisor.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `cadvisor` image |
...
| codeInsightsDB.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `codeinsights-db` image |
...
| codeIntelDB.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `codeintel-db` image |
...
| embeddings.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `embeddings` image |
...
| frontend.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `frontend` image |
...
| gitserver.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `gitserver` image |
...
| grafana.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `grafana` image |
...
| indexedSearch.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `zoekt-webserver` image |
...
| indexedSearchIndexer.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `zoekt-indexserver` image |
...
| jaeger.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `jaeger` image |
...
| migrator.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `migrator` image |
...
| nodeExporter.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `node-exporter` image |
...
| openTelemetry.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `otel-collector` image |
...
| pgsql.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `pgsql` image |
...
| postgresExporter.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `pgsql-exporter` image |
...
| preciseCodeIntel.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `precise-code-intel-worker` image |
...
| prometheus.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `prometheus` image |
...
| qdrant.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `qdrant` image |
...
| redisCache.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `redis-cache` image |
...
| redisExporter.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `redis-exporter` image |
...
| redisStore.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `redis-store` image |
...
| repoUpdater.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `repo-updater` image |
...
| searcher.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `searcher` image |
...
| symbols.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `symbols` image |
...
| syntectServer.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `syntect-server` image |
...
| worker.image.defaultTag | string | `"262142_2024-02-13_5.2-4db83b41b419"` | Docker image tag for the `worker` image |
