...
| codeInsightsDB.image.defaultTag | string | `"6.1.1295@sha256:bc83498752574240bdadc35217cc3f9260383cfad7837a574ea03072e013669b"` | Docker image tag for the `codeinsights-db` image |
...
| codeIntelDB.image.defaultTag | string | `"6.1.1295@sha256:735d3b09cd62ab48d0040dd08ad3c97ae5d13abffae6c2ace7ee7698c25978f1"` | Docker image tag for the `codeintel-db` image |
...
| pgsql.image.defaultTag | string | `"6.1.1295@sha256:735d3b09cd62ab48d0040dd08ad3c97ae5d13abffae6c2ace7ee7698c25978f1"` | Docker image tag for the `pgsql` image |
