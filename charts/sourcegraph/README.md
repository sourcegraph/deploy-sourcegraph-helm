...
| cadvisor.image.defaultTag | string | `"5.10.1164@sha256:295729384f5bb72e329378fd591da752133e4bc488f89fe145f868dee2f98e84"` | Docker image tag for the `cadvisor` image |
...
| codeInsightsDB.image.defaultTag | string | `"5.10.1164@sha256:25475cbcf84919366fda867fbbf592d3543445c90bea76435493808a7a0e5d1f"` | Docker image tag for the `codeinsights-db` image |
...
| codeIntelDB.image.defaultTag | string | `"5.10.1164@sha256:27a4ca48b2f4eb30c42689bf54674db4dcc71159ab8ffb609cf571489dfcc59d"` | Docker image tag for the `codeintel-db` image |
...
| frontend.image.defaultTag | string | `"5.10.1164@sha256:74ed155ab434de34f0abc80d9d4355492dad72e79180fa18745b8ab5e63a47b5"` | Docker image tag for the `frontend` image |
...
| grafana.image.defaultTag | string | `"5.10.1164@sha256:89d94f201bede3f90d70b63fda635b7702b6ba96e1eec2b1e0fff25052c9616a"` | Docker image tag for the `grafana` image |
...
| indexedSearch.image.defaultTag | string | `"5.10.1164@sha256:279cd92d283e52e96677baf2aa116d564579a5adeac88a0759b8e687675aa64f"` | Docker image tag for the `zoekt-webserver` image |
...
| indexedSearchIndexer.image.defaultTag | string | `"5.10.1164@sha256:77d41dcf21ee06a30bf46c5dd7c488d4be2206d80b8181423f53c932623f7053"` | Docker image tag for the `zoekt-indexserver` image |
...
| jaeger.image.defaultTag | string | `"5.10.1164@sha256:727f31464ac1c2de420868cf342e7009beaafd3dd7a253850a7ee1fd9edbad4e"` | Docker image tag for the `jaeger` image |
...
| openTelemetry.image.defaultTag | string | `"5.10.1164@sha256:8c5a4120317c30c02967980c992c1d8eb567af7a3d328c817e1852348c1463f7"` | Docker image tag for the `otel-collector` image |
...
| pgsql.image.defaultTag | string | `"5.10.1164@sha256:27a4ca48b2f4eb30c42689bf54674db4dcc71159ab8ffb609cf571489dfcc59d"` | Docker image tag for the `pgsql` image |
...
| preciseCodeIntel.image.defaultTag | string | `"5.10.1164@sha256:2ce6195520b57841d4a5eae1c8862003a1f5583fea21a32fa4df325cb6be220b"` | Docker image tag for the `precise-code-intel-worker` image |
...
| redisCache.image.defaultTag | string | `"5.10.1164@sha256:1be8b8493aabb9308e8f71b372193e4f027cafe05d634ff5fabfc95992d60a88"` | Docker image tag for the `redis-cache` image |
...
| redisExporter.image.defaultTag | string | `"5.10.1164@sha256:a40bd2c9c73fef1af4da030c8586247c885fbc307029c74b07ce960efff60330"` | Docker image tag for the `redis-exporter` image |
...
| redisStore.image.defaultTag | string | `"5.10.1164@sha256:1e197b3d7c819cd489f273eece68cf485d63d77749ee7f62da096f85c342342d"` | Docker image tag for the `redis-store` image |
...
| repoUpdater.image.defaultTag | string | `"5.10.1164@sha256:a3cabacb89f18099971f6a38b81ddf4f0a78b6410e96a976cba3b5da2fd707d5"` | Docker image tag for the `repo-updater` image |
...
| searcher.image.defaultTag | string | `"5.10.1164@sha256:ff91080729806f6253baabb537aa0295440f6afeff4d0618f56cf6eae3d4ca7a"` | Docker image tag for the `searcher` image |
...
| symbols.image.defaultTag | string | `"5.10.1164@sha256:f5a977abd6ef1fdb1d2c6861d967f16fbacebf01d11303d2b2e305263cf349f4"` | Docker image tag for the `symbols` image |
...
| syntacticCodeIntel.image.defaultTag | string | `"5.10.1164@sha256:cb9a16fafcd3e08ad4d7af7dbf4c9a8d2372495a809a41e6875d27313be2a59b"` | Docker image tag for the `syntactic-code-intel-worker` image |
...
| worker.image.defaultTag | string | `"5.10.1164@sha256:69d64bacac449f099824ac5d183f1da652d3f83bd068ff1aca94e26a33c1c0a2"` | Docker image tag for the `worker` image |
