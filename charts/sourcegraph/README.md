...
| alpine.image.defaultTag | string | `"5.2.6@sha256:dfdf0472af6932383163ab7622d8aa801e9775e621a3cb20dafe58d6ed0df06e"` | Docker image tag for the `alpine` image |
...
| codeInsightsDB.image.defaultTag | string | `"5.2.6@sha256:4cad586d2dc4978ae692419461f24a87049fcd354f6de6733b3e7875369d9ce1"` | Docker image tag for the `codeinsights-db` image |
...
| codeIntelDB.image.defaultTag | string | `"5.2.6@sha256:78d20336743096c94918c2bf31e14284b6d318efd7436a95a20620ab3cb58b1e"` | Docker image tag for the `codeintel-db` image |
...
| pgsql.image.defaultTag | string | `"5.2.6@sha256:78d20336743096c94918c2bf31e14284b6d318efd7436a95a20620ab3cb58b1e"` | Docker image tag for the `pgsql` image |
