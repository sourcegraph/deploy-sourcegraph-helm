...
| alpine.image.defaultTag | string | `"5.10.3940@sha256:143359e1741e003a8d99ff04338479aee864b2fb0aa05e2a901a9fe36b2ce0d3"` | Docker image tag for the `alpine` image |
...
| blobstore.image.defaultTag | string | `"5.10.3940@sha256:c20f4b1e5f0347e6542e71c6f787dced79cd585a574246f99561f32b90e8b780"` | Docker image tag for the `blobstore` image |
...
| cadvisor.image.defaultTag | string | `"5.10.3940@sha256:a48ec43a9af42dddcd4f64ff95181892f7e53b8d9225017e4638b4028a41623c"` | Docker image tag for the `cadvisor` image |
...
| codeInsightsDB.image.defaultTag | string | `"5.10.3940@sha256:1c62c5f406879bf8d17785c571eba9d4e6bed5fe6c5dca4f92d06a33bd14a55b"` | Docker image tag for the `codeinsights-db` image |
...
| codeIntelDB.image.defaultTag | string | `"5.10.3940@sha256:477d377c941a6bb2a1ff36bbdb000dace13417567175ce3e5e6d1b1c287b256d"` | Docker image tag for the `codeintel-db` image |
...
| frontend.image.defaultTag | string | `"5.10.3940@sha256:51b11424f7bd0f33278e71525b75f645031a12aed75f696d9479399d476f6dca"` | Docker image tag for the `frontend` image |
...
| gitserver.image.defaultTag | string | `"5.10.3940@sha256:5c282b0ddd3b940afdad676a159c311a2944be3d9aa2c604e036ac945dd5cede"` | Docker image tag for the `gitserver` image |
...
| grafana.image.defaultTag | string | `"5.10.3940@sha256:db40cc99cd2e094666308b1ab34f120d1857001f71c464143b1da898b1d442df"` | Docker image tag for the `grafana` image |
...
| indexedSearch.image.defaultTag | string | `"5.10.3940@sha256:13f4a3eaa849763780822b3b44397f3fd48f887c1fb2f0354193b827739dcc8b"` | Docker image tag for the `zoekt-webserver` image |
...
| indexedSearchIndexer.image.defaultTag | string | `"5.10.3940@sha256:c8d0656f651a4695f5c3eaf0f67dea832dae93ef30f8f21c43d326c8de32d7bd"` | Docker image tag for the `zoekt-indexserver` image |
...
| jaeger.image.defaultTag | string | `"5.10.3940@sha256:6f9a06449195de4f687c6d0cb2ccf97a7f073cd7d6e87380f4d8ab12e3d0db3b"` | Docker image tag for the `jaeger` image |
...
| nodeExporter.image.defaultTag | string | `"5.10.3940@sha256:54d57f4e8e9e9a4f4fa0003ff256cd395740e0ba7dcd5d580df105037192a465"` | Docker image tag for the `node-exporter` image |
...
| openTelemetry.image.defaultTag | string | `"5.10.3940@sha256:588eb62e63d09870fd63071ff5aa97a5e1accb60a1e6eeb2b5521493b04da606"` | Docker image tag for the `otel-collector` image |
...
| pgsql.image.defaultTag | string | `"5.10.3940@sha256:477d377c941a6bb2a1ff36bbdb000dace13417567175ce3e5e6d1b1c287b256d"` | Docker image tag for the `pgsql` image |
...
| postgresExporter.image.defaultTag | string | `"5.10.3940@sha256:4af8dfdc69f3bd8100902a1408a54ec3119d81cd25c55bb031b8dbb4e497c182"` | Docker image tag for the `pgsql-exporter` image |
...
| preciseCodeIntel.image.defaultTag | string | `"5.10.3940@sha256:3f4fa259d6dac9af170b71a2d264bd54d1ec8e5300f00ee189da880ac599c279"` | Docker image tag for the `precise-code-intel-worker` image |
...
| prometheus.image.defaultTag | string | `"5.10.3940@sha256:1dc99444832676a65d3ba9564c4ef83a425239593c50570793c66e663b29b161"` | Docker image tag for the `prometheus` image |
...
| redisCache.image.defaultTag | string | `"5.10.3940@sha256:e4e56db2670a279b9d9c00dd4bdb2f0b69955ed139558f9429760d8156c1d02c"` | Docker image tag for the `redis-cache` image |
...
| redisExporter.image.defaultTag | string | `"5.10.3940@sha256:9bf874e90306f910973b99a24c3609b55a37d698ea55f07d55ece6882af18001"` | Docker image tag for the `redis-exporter` image |
...
| redisStore.image.defaultTag | string | `"5.10.3940@sha256:a25ec754ddfa800d12fbd25b06fcbf0f3b3752a0e80b8095e0d3210404b5a6cb"` | Docker image tag for the `redis-store` image |
...
| repoUpdater.image.defaultTag | string | `"5.10.3940@sha256:4413bf60e5f2c788c0c3a19022fef6d425accea59d434eaa14a7b5e232f3a556"` | Docker image tag for the `repo-updater` image |
...
| searcher.image.defaultTag | string | `"5.10.3940@sha256:29a79695f2426385402920c1d3e1c6483f65b4fe1e3e79fbe5f6a752ba8c5529"` | Docker image tag for the `searcher` image |
...
| symbols.image.defaultTag | string | `"5.10.3940@sha256:487cbe050d5e24216a9012f4ef4607836471af3b58488659bf29f04baed69862"` | Docker image tag for the `symbols` image |
...
| syntacticCodeIntel.image.defaultTag | string | `"5.10.3940@sha256:b6aa70b0cde392fd6226dc999be0ef309b52b24731207087c2bc315beade7b0a"` | Docker image tag for the `syntactic-code-intel-worker` image |
...
| syntectServer.image.defaultTag | string | `"5.10.3940@sha256:3d90fe310d3c6d7a5f9f697b3d4c5416f5429128f3a26dc1ee34ca73d3373a23"` | Docker image tag for the `syntect-server` image |
...
| worker.image.defaultTag | string | `"5.10.3940@sha256:bed119e5c5fa756885ae86f19c3880cc2c91b632d2e2944c10c33cfa2b1faf35"` | Docker image tag for the `worker` image |
