...
- Corrected the external object storage examples to configure frontend, worker, precise code intel, gitserver, and searcher, including credentials or workload service accounts as required.
